; FROM: https://github.com/Shimao-Zhang/Formal-Languages-and-Automata/blob/master/programs/gcd.tm

; Input: a string of 0's and 1's, eg '1111110111'
; Calculate greatest common divisor of the lengths of two 1-strings
